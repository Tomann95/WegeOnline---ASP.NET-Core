...
namespace WegeOnline.Models
{
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public async Task<T> GetByIdAsync(int id, QueryOptions<T> options)
        {
            ...
            Microsoft.EntityFrameworkCore.Metadata.IProperty? key = _context.Model.FindEntityType(typeof(T))
        ...
        internal async Task<string?> GetByIdAsync(object id, QueryOptions<Ingredient> queryOptions)
        {
